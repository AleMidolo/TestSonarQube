def _get_alignment_value(self, alignment):
    """
        ...
        """
    alignment_mapping = {'left': WD_PARAGRAPH_ALIGNMENT.LEFT, 'center': WD_PARAGRAPH_ALIGNMENT.CENTER, 'right': WD_PARAGRAPH_ALIGNMENT.RIGHT, 'izquierda': WD_PARAGRAPH_ALIGNMENT.LEFT, 'centro': WD_PARAGRAPH_ALIGNMENT.CENTER, 'derecha': WD_PARAGRAPH_ALIGNMENT.RIGHT}
