...
class CalendarUtil: 
    ...
    def is_available(self, start_time, end_time):
        """
        Check if the calendar is available for a given time interval.
        :param start_time: The start time of the time interval, datetime.
        :param end_time: The end time of the time interval, datetime.
        :return: True if the calendar is available for the given time interval, False otherwise, bool.
        >>> calendar = CalendarUtil()
        >>> calendar.events = [{'date': datetime(2023, 1, 1, 0, 0), 'start_time': datetime(2023, 1, 1, 0, 0), 'end_time': datetime(2023, 1, 1, 1, 0), 'description': 'New Year'}]
