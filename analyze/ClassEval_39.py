    ...
    def calculate(self, expression):
        ...
        while self.postfix_stack:
            ...
            if not self.is_operator(current_op):
                result_stack.append(self.normalize_value(current_op))
            else:
                second_value = self.normalize_value(result_stack.pop())
                first_value = self.normalize_value(result_stack.pop())
